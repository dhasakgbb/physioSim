...
const toneVariants = {
  ...
  success:
    "bg-physio-accent-mint/15 text-physio-accent-mint border border-physio-accent-mint/30",
  warning:
    "bg-physio-warning/15 text-physio-warning border border-physio-warning/30",
  neutral:
    "bg-physio-bg-tertiary/70 text-physio-text-secondary border border-physio-bg-border/70",
};
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      {insights.map((insight) => (
        ...
        >
          <span className="text-[10px] text-physio-text-tertiary/80">
            {insight.label}
          </span>
