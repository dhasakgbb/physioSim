...
const toneStyles = {
  ...
  success:
    "text-physio-accent-mint border-physio-accent-mint/40 bg-physio-accent-mint/5",
...
const GuardrailChip = ({
  ...
  return (
    ...
    >
      <span>{label}</span>
      {detail && (
        <span className="font-medium normal-case tracking-normal text-[11px] opacity-80">
          {detail}
        </span>
      )}
    </span>
