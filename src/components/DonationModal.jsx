        ...
        <div className="p-6 space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-physio-text-secondary leading-relaxed">
              PhysioSim is a free tool. If you find it valuable for your
              research, consider supporting its continued development.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div className="flex-shrink-0 text-physio-text-tertiary group-hover:text-physio-accent-primary transition-colors">
                {copied ? (
                  <span className="text-physio-accent-success font-bold text-xs">
                    COPIED
                  </span>
                ) : (
                  <svg
