  ...
  const CustomRadarTooltip = ({ active, payload }) => {
    ...
    return (
      <div className="bg-physio-bg-surface/95 backdrop-blur-md border border-physio-border-strong p-3 rounded-lg shadow-xl z-50">
        <p className="text-[10px] uppercase text-physio-text-tertiary mb-1">{payload[0].name}</p>
  ...
  return (
    <div className="absolute inset-0 flex flex-col bg-physio-bg-core">
      ...
      <div className="flex-1 w-full min-h-0 relative flex items-center justify-center">
        ...
        <div className="absolute bottom-4 left-6 text-[9px] text-physio-text-tertiary flex flex-col gap-1 opacity-50 pointer-events-none">
