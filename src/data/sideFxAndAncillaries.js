    ...
    sides: [
      {
        ...
        timeline:
          "Onset week 3-6; reversible with dopamine agonists; may persist 2-4 weeks post-cycle",
      },
      {
        name: "Gynecomastia (Prolactin-mediated)",
        severity: "medium",
        description:
          "Breast tissue from prolactin elevation (different mechanism than E2)",
        management: [
  ...
  androgenic: {
    ...
    sides: [
      ...
      },
      {
        ...
        timeline:
          "Irreversible if follicles miniaturized; genetic susceptibility varies",
      },
      {
    ...
    sides: [
      {
        ...
        timeline:
          "Elevation begins week 1-2; reversible if caught early; can lead to permanent damage if ignored",
      },
      {
        name: "Jaundice",
        severity: "high",
    ...
    sides: [
      {
        ...
        severity: "high",
        description:
          "Elevated blood pressure from fluid retention, RBC, vascular effects",
        management: [
        ...
        timeline:
          "Develops week 2-4; cumulative; can persist post-cycle if LVH developed",
      },
      {
        name: "Lipid Decline",
        severity: "high",
        ...
        timeline:
          "Begins week 2-3; worst with orals and Tren; partially reversible post-cycle",
      },
      {
        name: "Left Ventricular Hypertrophy (LVH)",
        severity: "high",
        description:
          "Pathological heart enlargement from prolonged hypertension",
        management: [
        ...
        timeline:
          "Develops over months-years; cumulative; prevention essential",
      },
      {
        ...
        timeline:
          "Develops week 4-8; worst with EQ and high Test; reversible with donation",
      },
    ],
  },
  ...
  psychological: {
    ...
    sides: [
      ...
      },
      {
        ...
        timeline:
          "EQ: week 4-8 (20-40% of users); Tren: week 2-4 (dose-dependent)",
      },
      {
        name: "Insomnia",
        severity: "medium-high",
        ...
        timeline:
          "Tren: nearly universal; begins week 1; resolves 1-2 weeks post-cycle",
      },
    ],
  },
};
...
export const ancillaries = {
  ...
  anastrozole: {
    ...
    sides:
      "Joint pain, low libido (if E2 crashed), mood issues, lipid worsening",
    caution:
      "Crashing E2 is worse than high E2; titrate based on symptoms and bloodwork",
    cost: {
      weekly: 2,
      unit: "USD",
  ...
  letrozole: {
    ...
    caution:
      "⚠️ TOO POTENT for most users; reserve for gyno emergencies; crashes E2 easily",
    cost: {
      weekly: 3,
      unit: "USD",
      note: "Generic; affordable",
  ...
  exemestane: {
    ...
    mechanism:
      "Permanently deactivates aromatase; cannot rebound; mildly androgenic",
    dosing: {
    ...
    caution:
      "Cannot adjust E2 upward quickly (irreversible); titrate carefully",
    cost: {
      weekly: 5,
      unit: "USD",
  ...
  tamoxifen: {
    ...
    category: "serm",
    mechanism:
      "Selective estrogen receptor modulator; blocks E2 at breast tissue; used in PCT",
    dosing: {
    ...
    sides:
      "Mood swings, libido changes, vision issues (rare), blood clot risk (rare)",
    caution:
      "Raises serum E2 (blocks receptors but not production); not ideal for on-cycle E2 management",
    cost: {
      weekly: 3,
      unit: "USD",
  ...
  raloxifene: {
    ...
    category: "serm",
    mechanism:
      "SERM with stronger anti-estrogenic effect at breast tissue than tamoxifen",
    dosing: {
  ...
  clomid: {
    ...
    sides:
      "Vision issues (more common than tamoxifen), mood swings, emotional lability",
  ...
  cabergoline: {
    ...
    mechanism:
      "D2 receptor agonist; reduces prolactin secretion from pituitary",
    dosing: {
      npp_tren: "0.25-0.5mg twice weekly",
      high_prolactin: "0.5-1mg twice weekly",
    },
    sides:
      "Nausea (take with food), dizziness, impulse control issues (rare; at high doses)",
    ...
    advantages:
      "Gold standard for prolactin control; twice-weekly dosing convenient",
  },
  ...
  tudca: {
    ...
    mechanism:
      "Bile acid derivative; prevents cholestasis; reduces hepatocyte apoptosis",
    dosing: {
  ...
  nac: {
    ...
    category: "liver_support",
    mechanism:
      "Glutathione precursor; antioxidant; reduces oxidative liver stress",
    dosing: {
  ...
  telmisartan: {
    ...
    mechanism:
      "Blocks angiotensin II receptors; vasodilation; BP reduction; PPAR-gamma agonism (metabolic benefits)",
    dosing: {
    ...
    advantages:
      "PPAR-gamma effects; insulin sensitivity; lipid benefits; renal protection",
  },
  ...
  nebivolol: {
    ...
    mechanism:
      "Cardioselective beta blocker; reduces heart rate and contractility; nitric oxide release",
    dosing: {
  ...
  fish_oil: {
    ...
    mechanism:
      "Omega-3 fatty acids; reduces triglycerides; mild HDL benefit; anti-inflammatory",
    dosing: {
    ...
    sides:
      "Fishy burps (take with food or use enteric-coated); bleeding risk at very high doses",
  ...
  rosuvastatin: {
    ...
    caution:
      "Use if lipids severely impacted (LDL >160, HDL <30); monitor liver function",
    cost: {
      weekly: 4,
      unit: "USD",
      note: "Generic; affordable",
  ...
  berberine: {
    ...
    category: "lipid_support",
    mechanism:
      "AMPK activator; improves insulin sensitivity; modest lipid benefits",
    dosing: {
  ...
  hcg: {
    ...
    mechanism:
      "LH analog; stimulates testicular Leydig cells; maintains testicular function during suppression",
    dosing: {
    ...
    caution:
      "Desensitizes Leydig cells if dosed too high or too frequently; use moderate doses",
    cost: {
      weekly: 15,
      unit: "USD",
    ...
    availability: "Prescription; gray market",
    advantages:
      "Maintains fertility; easier PCT recovery; prevents testicular atrophy",
...
export const getAncillaryProtocol = (stack) => {
  ...
  // Get total Test dose
  const testDose =
    stack.find((item) => item.compound === "testosterone")?.dose || 0;
  ...
  protocol.monitoring.push({
    ...
    action:
      "Start BP medication if consistently >140/90; doctor visit if >150/95",
  });
