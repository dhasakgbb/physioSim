...
export const interactionHeatmapModes = [
  {
    key: "benefit",
    label: "Benefit Focus",
    description: "Highlights strong positive synergies.",
  },
  {
    key: "risk",
    label: "Risk Focus",
    description: "Highlights penalty-heavy stacks.",
  },
  {
    key: "volatility",
    label: "Volatility",
    description: "Large swings (good or bad) show up hot.",
  },
];
...
export const stackOptimizerCombos = [
  {
    ...
    narrative:
      "Classic lean mass cruise with dryness by layering Mast onto Test+EQ.",
  ...
  },
  {
    ...
    narrative:
      "High-androgen recomposition: Test base with Tren aggression and Mast dryness.",
  ...
  },
  {
    ...
    narrative:
      "Strength-focused blend where NPP cushions joints and Dbol handles neural drive.",
  ...
  },
  {
    ...
    label: "Endurance Cut",
    narrative:
      "Long, lean cut leveraging EQ endurance plus Anavar hardness on a TRT base.",
...
export const interactionPairs = {
  testosterone_npp: {
    ...
    summary:
      "Classic mass stack: Test base with nandrolone joint relief and fullness.",
    ...
    narratives: {
      highlight:
        "NPP bolsters connective tissue and adds lean tissue density on top of a Test base.",
      caution:
        "Dual estrogen/progestin management required; prolactin creeps fast above 350mg.",
    },
  },
  testosterone_eq: {
    id: "testosterone_eq",
    ...
    narratives: {
      highlight:
        "EQ amplifies lean mass per mg and adds vascularity when RBC is managed.",
      caution:
        "Hematocrit climbs quickly; blood donation cadence becomes the limiting factor.",
    },
  },
  testosterone_trenbolone: {
    ...
    narratives: {
      highlight:
        "Tren’s androgen receptor efficiency spikes when backed by ample Test, enabling drastic recomp.",
      caution:
        "Psychological volatility and BP load explode beyond 300mg Tren if Test stays high; cap duration to 10-12 weeks.",
    },
  },
  testosterone_masteron: {
    ...
    narratives: {
      highlight:
        "Masteron trims water and adds graininess while the Test base preserves libido and drive.",
      caution:
        "Low E2 risk if total aromatizing dose is modest; monitor joints/libido when running high Mast ratios.",
    },
  },
  testosterone_primobolan: {
    ...
    narratives: {
      highlight:
        "Primo extends the anabolic curve without aromatase baggage, perfect for long recomp blocks.",
      caution:
        "Under-dosed raws common; verify supply. Mild but cumulative RBC impact when run >16 weeks.",
    },
  },
  trenbolone_masteron: {
    ...
    narratives: {
      highlight:
        "Stage hardness and dryness shoot up when Tren’s aggression is balanced by Mast’s anti-estrogenic edge.",
      caution:
        "Too little baseline Test drives estrogen deficit: libido crash, flat mood, joint pain.",
    },
  },
  trenbolone_eq: {
    id: "trenbolone_eq",
    ...
    label: "Tren + EQ",
    summary:
      "Endurance + recomp mashup for contest preps with high RBC vigilance.",
    defaultDimension: "anabolic",
    doseRanges: {
      trenbolone: [0, 600],
      eq: [0, 1000],
    ...
    narratives: {
      highlight:
        "EQ’s appetite/endurance dampens Tren lethargy, enabling brutal prep blocks.",
      caution:
        "RBC and BP skyrocket; mandatory phlebotomy schedule and cardiology-level monitoring.",
    },
  },
  npp_dianabol: {
    id: "npp_dianabol",
    ...
    label: "NPP + Dbol",
    summary:
      "Joint-friendly brute strength with massive bloat and BP penalties.",
    defaultDimension: "strength",
    doseRanges: {
      npp: [0, 600],
      dianabol: [0, 80],
    ...
    narratives: {
      highlight:
        "Explosive strength jumps with knees and elbows thanking you thanks to NPP.",
      caution:
        "Bloat and BP skyrocket beyond 30mg Dbol; hepatic strain is the hard stop.",
    },
  },
  trenbolone_npp: {
    id: "trenbolone_npp",
    ...
    label: "Tren + NPP",
    summary:
      "Hybrid 19-nor stack where Tren provides density/hardness and NPP restores fullness + joint comfort when doses stay sane.",
    defaultDimension: "anabolic",
    doseRanges: {
      trenbolone: [0, 600],
      npp: [0, 600],
    ...
    narratives: {
      highlight:
        "Moderate Tren paired with mid-range NPP rides the “synergy ridge” for hardness + pumps while joints stay happy.",
      caution:
        "Dual 19-nor suppression is unforgiving—treat high-dose/high-duration blocks as structurally expensive and monitor BP, HCT, prolactin, and sleep relentlessly.",
    },
    phaseAtlas: {
      subtitle: "Tren + NPP conceptual atlas",
      title: "Phase Map · Benefit vs Risk Surfaces",
      description:
        "Normalized 0–1 dose space using your personalization. Thinking tool only, not medical advice.",
      benefitCaption:
        "Golden mist shows total benefit. Riding from P1 → P3 yields the biggest delta.",
      riskCaption:
        "Orange flare shows cumulative burden. The P4 corner is the cliff—reserve it for short experiments.",
      phases: [
        {
          id: "P0",
          a: 0,
          ...
          summary:
            "Baseline TRT + support meds. All response comes from lifestyle, not 19-nors.",
        },
        {
          id: "P1",
          a: 0.4,
          ...
          summary:
            "Tren doing the heavy lifting at ~0.4 relative dose. Already near the top of the Tren benefit curve.",
        },
        {
          id: "P2",
          a: 0.8,
          ...
          summary:
            "Big jump in dose for marginal benefit, sharp risk inflection. Pure “Tren wall climbing”.",
        },
        {
          id: "P3",
          a: 0.5,
          ...
          summary:
            "Moderate Tren with moderate NPP. Hardness + pumps + joint comfort. This is the sweet ridge.",
        },
        {
          id: "P4",
          a: 0.8,
          ...
          title: "Both high",
          summary:
            "Maxed-ish Tren and NPP. Top of the benefit mountain, but hugging the risk cliff.",
        },
      ],
    },
  },
  testosterone_dianabol: {
    ...
    narratives: {
      highlight:
        "Dbol multiplies Test’s acute glycogen swell, translating to 2-3 week strength ramps.",
      caution:
        "Estrogenic/bloat management becomes the limiting factor; liver strain beyond 40mg is exponential.",
    },
  },
  testosterone_anadrol: {
    ...
    label: "Test + Anadrol",
    summary:
      "Seismic strength and fullness with immediate BP/hepatic warnings.",
    defaultDimension: "strength",
    doseRanges: {
      testosterone: [0, 900],
      anadrol: [0, 100],
    ...
    narratives: {
      highlight:
        "Powerlifters bank on the immediate leverage boost from Anadrol stacked atop Test.",
      caution:
        "BP and hepatic markers skyrocket—treat >50mg as redline territory.",
    },
  },
  eq_anavar: {
    id: "eq_anavar",
    ...
    narratives: {
      highlight:
        "Anavar adds neural drive and hardness to EQ’s appetite/endurance platform.",
      caution:
        "Despite mild branding, hepatic stress accrues when Anavar is held beyond 8 weeks.",
    },
  },
  masteron_primobolan: {
    ...
    summary:
      "Ultra-clean cosmetic stack for long cuts with minimal systemic stress.",
    defaultDimension: "vascularity",
    doseRanges: {
      masteron: [200, 600],
      primobolan: [300, 800],
    ...
    narratives: {
      highlight:
        "Primo’s slow, dry tissue plus Masteron’s anti-estrogenic hardness keeps physiques sharp for months.",
      caution:
        "Extremely low aromatase context; ensure a baseline Test/TRT dose to protect mood and joints.",
    },
  },
  eq_primobolan: {
    id: "eq_primobolan",
    ...
    narratives: {
      highlight:
        "Pairs two mild compounds for marathon recomp blocks where appetite and endurance stay high.",
      caution:
        "Hematocrit remains the limiting factor—donation cadence is mandatory past week 10.",
    },
  },
  testosterone_winstrol: {
    ...
    summary:
      "Contest cut combo: Test maintains fullness while Winny peels water.",
    defaultDimension: "vascularity",
    doseRanges: {
    ...
    narratives: {
      highlight:
        "Adds crispness and tendon-drive near showtime without flattening muscle thanks to Test support.",
      caution:
        "Expect joint dryness and hepatic strain after week 4; keep Winny short.",
    },
  },
  trenbolone_winstrol: {
    ...
    label: "Tren + Winstrol",
    summary:
      "Nuclear dryness stack: maximum hardness with brutal joint/neuro toll.",
    defaultDimension: "vascularity",
    doseRanges: {
      trenbolone: [0, 400],
      winstrol: [20, 70],
    ...
    narratives: {
      highlight:
        "Stage-ready dryness in 4 weeks; Winstrol amplifies Tren’s neural drive for peak strength.",
      caution:
        "Combines the worst joint + neuro + hepatic penalties—reserve for short, supervised blasts.",
    },
  },
  testosterone_halotestin: {
    ...
    summary:
      "Meet-week aggression stack for lifters needing maximal CNS output.",
    defaultDimension: "strength",
    doseRanges: {
    ...
    narratives: {
      highlight:
        "Halotestin stacks on TRT/Test background deliver unmatched neural aggression for meet day.",
      caution:
        "Toxicity limits use to 10-14 days; monitor BP and hepatic labs closely.",
    },
  },
  trenbolone_halotestin: {
    ...
    label: "Tren + Halo",
    summary:
      "Only for the insane: max CNS drive with crippling neuro/hepatic risk.",
    defaultDimension: "strength",
    doseRanges: {
      trenbolone: [150, 400],
      halotestin: [5, 30],
    ...
    narratives: {
      highlight:
        "Contest peak for elite strength athletes chasing sheer aggression.",
      caution:
        "Stack is neurologically volatile and liver-toxic—should only be used briefly under supervision.",
    },
  },
  testosterone_superdrol: {
    ...
    narratives: {
      highlight:
        "Superdrol delivers massive strength and fullness in 3-4 weeks when backed by Test.",
      caution:
        "Liver toxicity is extreme—treat >20mg as redline, limit to 4 weeks max.",
    },
  },
  superdrol_anadrol: {
    ...
    narratives: {
      ...
      caution:
        "Dual C17-aa methylation causes exponential liver enzyme elevation. Not recommended.",
    },
  },
  testosterone_turinabol: {
    ...
    narratives: {
      highlight:
        "Tbol adds dry lean gains without aromatization, ideal for athletic performance.",
  ...
  testosterone_proviron: {
    ...
    narratives: {
      highlight:
        "Proviron binds SHBG, freeing more testosterone. Adds hardness and libido support with minimal toxicity.",
      caution:
        'Excellent addition to any Test base - standard "glue" for advanced stacks.',
    },
  },
  npp_proviron: {
    id: "npp_proviron",
  ...
  superdrol_turinabol: {
    ...
    narratives: {
      ...
      caution:
        "High hepatic burden. Use only at very low doses for short duration.",
    },
  },
};
