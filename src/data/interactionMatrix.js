...
export const normalizeStackInput = (stackInput, providedDoses = {}) => {
  ...
  Object.entries(providedDoses || {}).forEach(([key, value]) =>
    assignDose(key, value),
  );
...
export const interactionMatrix = {
  ...
  testosterone_npp: {
    description:
      "Excellent synergy; joint-protective stack with solid mass gains",
  ...
  testosterone_trenbolone: {
    description:
      "Powerful recomp stack; significant psychological and cardiovascular risk",
    ...
    recommendedRatio:
      "Test:Tren = 2:1 to 3:1 (e.g., 600mg Test : 200-300mg Tren)",
    recommendedProtocol: {
    ...
    caution:
      "⚠️ HIGH RISK: Psychological stability required; aggressive lipid + BP management essential; expect insomnia, aggression, reduced cardio capacity",
    stackBenefit:
      "Exceptional recomp: simultaneous muscle gain + fat loss; strength surge",
    stackRisk:
      "Severe: lipids (HDL crash), cardio stress, psychological sides, HPTA shutdown, sleep disruption",
    rating: "caution",
  },
  ...
  testosterone_eq: {
    ...
    caution:
      "EQ anxiety in ~20-40% of users (mechanism unclear); HCT elevation requires blood donation",
    stackBenefit:
      "Clean lean mass, endurance boost, vascularity, appetite stimulation",
    stackRisk:
      "Low-moderate: HCT elevation (primary concern), mild lipid impact, possible anxiety",
    rating: "good",
  },

  testosterone_masteron: {
    description:
      "Aesthetic finisher stack; hardening compound added to Test base",
    ...
    recommendedRatio:
      "Test:Masteron = 2:1 to 3:2 (e.g., 600mg Test : 300-400mg Masteron)",
    recommendedProtocol: {
      testDose: "400-600mg/week",
    ...
    caution:
      "Masteron accelerates hair loss (MPB-prone avoid); prostate monitoring for >40yo",
    stackBenefit:
      "Muscle hardening, definition, reduced bloat, full + dry look",
    stackRisk:
      "Low: hair loss (DHT derivative), mild prostate concern, standard lipid impact",
    rating: "good",
  },
  ...
  testosterone_primobolan: {
    ...
    recommendedRatio:
      "Test:Primo = 1:1 to 2:3 (e.g., 500mg Test : 600mg Primo)",
    recommendedProtocol: {
      testDose: "400-600mg/week",
    ...
    recommendation:
      "Excellent for first-time stackers or those prioritizing safety",
    caution:
      "Expensive; verify Primo legitimacy (counterfeiting common); weak gains relative to cost",
    stackBenefit:
      "Slow, quality lean gains; excellent lipid profile; minimal sides; well-tolerated",
    stackRisk:
      "Very low: among safest stacks available; standard HPTA suppression only",
    rating: "good",
  },
  ...
  testosterone_ment: {
    ...
    recommendedRatio:
      "Test (TRT) : MENT (Low) - e.g., 150mg Test : 10-20mg/day MENT",
    recommendedProtocol: {
    ...
    caution:
      "⚠️ HIGH RISK: Gyno risk extreme; infertility risk high; very little human safety data",
    stackBenefit: "Rapid, extreme mass gains; strength surge",
    stackRisk:
      "High: Estrogen control difficult, infertility, lipids, unknown long-term safety",
    rating: "caution",
  },
  ...
  testosterone_dhb: {
    ...
    recommendation:
      "Good alternative to Tren for those who can't handle mental sides",
  ...
  trenbolone_npp: {
    description:
      "Conceptual “ridge ride”: Tren provides density while NPP restores fullness and joint comfort when both stay in the mid-bands.",
    ...
    recommendedRatio:
      "Think in phases: P1 (Tren-only), slide toward P3 (Tren 0.5 · NPP 0.3), reserve P4 (0.8/0.8) for short experiments.",
    recommendedProtocol: {
    ...
    recommendation:
      "Advanced experimentation only; build logs by phase instead of blindly escalating dose.",
    caution:
      "Treat high-dose, long-duration blocks as structurally expensive time. Sleep loss, rising BP, or prolactin creep = step back toward P1/P2 immediately.",
    stackBenefit:
      "Noticeable jump in hardness + pumps at P3 without needing Tren mega-doses; P4 is the “all-in” zone for short bursts.",
    stackRisk:
      "Moderate-to-high: neuro strain, BP/HCT, dual prolactin drivers, extended recovery time.",
    rating: "caution",
  },
  ...
  npp_eq: {
    ...
    recommendation:
      "Compatible; works well for specific goals (mass + endurance)",
    caution:
      "Mood monitoring (prolactin + anxiety possible); HCT management critical",
    stackBenefit: "Mass, joint health, endurance, vascularity, appetite",
    stackRisk:
      "Moderate: prolactin, HCT elevation, potential mood issues, HPTA suppression",
    rating: "compatible",
  },
  ...
  npp_masteron: {
    ...
    recommendedRatio:
      "NPP:Masteron = 1:1 to 2:1 (e.g., 400mg NPP : 300mg Masteron)",
    recommendedProtocol: {
    ...
    stackBenefit:
      "Full, hard muscles; recomp effect; joint health + definition",
  ...
  npp_primobolan: {
    ...
    recommendedRatio:
      "NPP:Primo = 1:1.5 to 1:2 (e.g., 300mg NPP : 600mg Primo)",
    recommendedProtocol: {
      nppDose: "200-400mg/week",
    ...
    stackBenefit:
      "Quality lean tissue, joint health, minimal sides, good lipid profile",
  ...
  trenbolone_eq: {
    ...
    recommendedProtocol: {
      ...
      monitoring:
        "Frequent BP checks, HCT monitoring, lipid panels every 6 weeks",
    },
    recommendation: "Use with caution; advanced users only",
    caution:
      "⚠️ Psychological monitoring essential; HCT management critical; aggressive lipid protocol required",
    stackBenefit:
      "Exceptional recomp, endurance despite Tren, vascularity, appetite",
    stackRisk:
      "High: mood instability (aggression + anxiety), severe lipids, HCT elevation, cardio stress",
    rating: "caution",
  },
  ...
  trenbolone_masteron: {
    ...
    recommendedRatio:
      "Tren:Masteron = 1:1 to 2:3 (e.g., 300mg Tren : 400mg Masteron)",
    recommendedProtocol: {
      trenDose: "200-400mg/week",
    ...
    caution:
      "⚠️ Extreme aesthetics at cost of health metrics; hair loss severe; psychological stability required; aggressive ancillary protocol essential",
    stackBenefit:
      "Peak contest conditioning: shredded, dry, vascular, hard muscles",
    stackRisk:
      "High: severe lipids, psychological sides, hair loss, cardio stress, sleep disruption",
    rating: "caution",
  },

  trenbolone_primobolan: {
    description:
      "Quality recomp with harm reduction attempt; Primo mitigates some Tren harshness",
    ...
    recommendedRatio:
      "Tren:Primo = 1:2 to 1:2.5 (e.g., 300mg Tren : 600mg Primo)",
    recommendedProtocol: {
      trenDose: "200-400mg/week",
      primoDose: "600-800mg/week",
      testBase: "TRT to low-moderate (200-400mg)",
    ...
    recommendation:
      "Compatible; Primo adds quality without compounding Tren risks significantly",
    caution: "Expensive; Tren sides still dominant; verify Primo legitimacy",
    stackBenefit:
      "Quality recomp, less harsh than Tren-only, Primo adds lean tissue",
    stackRisk:
      "Moderate-high: Tren psychological + cardio + lipid risks remain; cost",
    rating: "compatible",
  },
  ...
  eq_masteron: {
    ...
    recommendedRatio:
      "EQ:Masteron = 2:1 to 3:2 (e.g., 600mg EQ : 400mg Masteron)",
    recommendedProtocol: {
      eqDose: "600-800mg/week",
      masteronDose: "300-500mg/week",
    ...
    caution:
      "HCT management essential; EQ anxiety possible; hair loss from Masteron",
    stackBenefit:
      "Lean mass, endurance, vascularity, muscle hardness, definition",
    stackRisk:
      "Low-moderate: HCT elevation, possible anxiety, hair loss (MPB-prone)",
    rating: "good",
  },
  ...
  eq_primobolan: {
    ...
    recommendation:
      "Excellent for safety-conscious users; quality over quantity",
    caution: "Expensive; slow gains; requires patience; HCT monitoring needed",
    stackBenefit:
      "Slow, quality lean gains; excellent lipid profile; minimal sides; endurance",
  ...
  masteron_primobolan: {
    ...
    recommendedRatio:
      "Masteron:Primo = 1:1 to 2:3 (e.g., 400mg Masteron : 600mg Primo)",
    recommendedProtocol: {
      masteronDose: "300-500mg/week",
      primoDose: "600-800mg/week",
    ...
    caution:
      "Weak mass gains; expensive; hair loss (Masteron); verify Primo source",
    stackBenefit:
      "Muscle hardness, quality tissue, excellent lipid profile, minimal bloat",
  ...
  testosterone_dianabol: {
    ...
    caution:
      "⚠️ E2 management critical; dual aromatization = high gyno risk; hepatic + lipid monitoring essential",
    stackBenefit:
      "Rapid mass + strength; immediate gains while Test builds; classic bulking stack",
    stackRisk:
      "High: dual E2 elevation, hepatic stress, lipid crash, BP spike, water retention",
    rating: "good",
  },
  ...
  npp_dianabol: {
    ...
    recommendedRatio:
      "NPP 300-400mg/week + Dbol 20mg/day (weeks 1-4) + Test 300-500mg base",
    recommendedProtocol: {
      nppDose: "300-400mg/week",
    ...
    caution:
      "Water retention extreme; E2 + prolactin management critical; hepatic + lipid stress",
    stackBenefit: "Massive size gains, joint health, rapid kickstart",
    stackRisk:
      "High: water retention, E2 + prolactin, hepatic, lipids, complex management",
    rating: "compatible",
  },
  ...
  trenbolone_dianabol: {
    ...
    recommendedRatio:
      "NOT commonly recommended; if used: Tren 200-300mg + Dbol 20mg (2-3 weeks only) + Test base",
    recommendation: "Use with extreme caution; conflicting compound profiles",
    caution:
      "⚠️ HIGH RISK: Lipid devastation, BP critical, psychological stress, hepatic, complex management; many consider this combination poor planning",
    stackBenefit:
      "Strength surge, rapid mass; questionable synergy due to conflicting goals",
    stackRisk:
      "Extreme: lipids, BP, psychological, hepatic, complexity; risk often exceeds benefit",
    rating: "caution",
  },
  ...
  testosterone_anadrol: {
    ...
    recommendedRatio:
      "Test 500-700mg/week + Adrol 50-75mg/day (weeks 5-8 or 9-12)",
    recommendedProtocol: {
    ...
    recommendation:
      "Advanced users only; extreme mass gains at significant health cost",
    caution:
      "⚠️ EXTREME RISK: Hepatic stress critical, lipids devastated, BP dangerous, limit to 4 weeks; bloodwork every 3 weeks mandatory",
    stackBenefit: "Extreme mass surge, plateau breakthrough, dramatic strength",
    stackRisk:
      "Extreme: hepatic (severe), lipids (devastated), BP (critical), water retention, lethargy",
    rating: "caution",
  },
  ...
  trenbolone_anadrol: {
    ...
    recommendedRatio:
      "Tren 300-400mg + Adrol 50mg (2-3 weeks MAXIMUM) + Low Test base",
    recommendation:
      "Extreme advanced only; contest prep final weeks; NOT for general use",
    caution:
      "⚠️ CRITICAL RISK: Among harshest combinations possible; hepatic failure risk, lipids critical, psychological unpredictability, BP dangerous; many coaches advise against",
    stackBenefit: "Contest conditioning + fullness paradox; strength peak",
    stackRisk:
      "Critical: hepatic (extreme), lipids (critical), BP (dangerous), psychological, lethargy",
    rating: "dangerous",
  },
  ...
  testosterone_winstrol: {
    ...
    caution:
      "Joint pain nearly universal >50mg Winny; lipid devastation; limit to 6 weeks; monitor closely",
    stackBenefit:
      "Muscle hardness, definition, dry look, strength preservation in deficit",
    stackRisk:
      "High: lipids (extreme), joint pain (severe), hepatic, tendon injury risk",
    rating: "good",
  },
  ...
  masteron_winstrol: {
    ...
    recommendedRatio:
      "Masteron 400mg/week + Winny 50mg/day (final 4-6 weeks) + Test 200-300mg",
    recommendedProtocol: {
      masteronDose: "400-600mg/week",
    ...
    caution:
      "Joint pain, lipids severe, hair loss (both DHT), hepatic; short duration only",
    stackBenefit:
      "Peak muscle hardness, extreme definition, dry + vascular look",
  ...
  testosterone_anavar: {
    ...
    recommendation:
      "Excellent for first-time oral users or cutting; well-tolerated",
    caution:
      "Verify Var legitimacy (most counterfeited); lipid monitoring still needed; expensive",
    stackBenefit:
      "Quality lean gains, hardening, well-tolerated, longer run time possible",
    stackRisk:
      "Moderate: lipids (manageable), cost, source verification critical",
    rating: "excellent",
  },
  ...
  primobolan_anavar: {
    ...
    caution:
      "Expensive; slow gains; verify sources (both commonly faked); patience required",
    stackBenefit:
      "Slow quality lean gains, excellent tolerability, good lipid profile, minimal sides",
  ...
  testosterone_halotestin: {
    description:
      "Strength peaking or contest prep final week; extreme compound",
    ...
    recommendedRatio:
      "Test 300-500mg/week + Halo 10-20mg/day (2-3 weeks MAXIMUM)",
    recommendedProtocol: {
      testDose: "300-500mg/week",
    ...
    caution:
      "⚠️ CRITICAL: Hepatic toxicity extreme; psychological unpredictability; lipids devastated; 2-3 weeks MAXIMUM; many users report not worth risk",
    stackBenefit: "Extreme strength spike, cosmetic hardening, CNS stimulation",
    stackRisk:
      "Critical: hepatic (extreme), psychological (severe aggression), lipids (devastated)",
    rating: "dangerous",
  },
  ...
  dianabol_anadrol: {
    ...
    caution:
      "⚠️ FORBIDDEN: Hepatic failure risk; lipids critical; NO benefit justifies dual oral stress",
    stackBenefit: "None; contradictory compound profiles",
    stackRisk:
      "Critical: hepatic failure possible, lipids catastrophic, BP critical",
    rating: "forbidden",
  },
  ...
  dianabol_winstrol: {
    ...
    recommendation:
      "❌ FORBIDDEN - Conflicting (Dbol wet/bulk, Winny dry/cut); dual hepatic stress unjustifiable",
    caution:
      "⚠️ FORBIDDEN: Hepatic stress multiplicative; conflicting mechanisms make stack illogical",
  ...
  anadrol_winstrol: {
    ...
    synergy: { benefit: 0, risk: 1.0 },
    recommendation:
      "❌ FORBIDDEN - Adrol (wet/mass) + Winny (dry/cut) = illogical; dual oral hepatic stress extreme",
    caution:
      "⚠️ FORBIDDEN: Among worst oral combinations possible; hepatic critical; no synergy",
    stackRisk:
      "Critical: hepatic extreme, lipids catastrophic, joint pain + water retention paradox",
    rating: "forbidden",
  },
  ...
  anavar_winstrol: {
    ...
    recommendation:
      "❌ FORBIDDEN - Similar mechanisms; dual hepatic stress unjustifiable; use one OR the other",
    caution:
      "⚠️ FORBIDDEN: Redundant mechanisms; dual oral stress; lipids severe; joint pain from Winny",
  ...
  eq_anavar: {
    ...
    caution:
      "HCT management critical (EQ); verify Var source; EQ anxiety + Var generally neutral",
  ...
  trenbolone_winstrol: {
    ...
    recommendedRatio:
      "Tren 300-400mg/week + Winny 50mg/day (4-6 weeks) + Test 200mg",
    recommendedProtocol: {
    ...
    caution:
      "⚠️ HIGH RISK: Lipids catastrophic, psychological stress, joint pain, sleep disruption; advanced only",
    stackBenefit:
      "Peak contest conditioning, extreme hardness + dryness, vascularity",
    stackRisk:
      "Extreme: lipids (catastrophic), psychological, joint pain, sleep, hepatic",
    rating: "dangerous",
  },
  ...
  testosterone_superdrol: {
    ...
    caution:
      "⚠️ HIGH RISK: Liver toxicity extreme; lipids crushed; lethargy common",
  ...
  // NEW ADDITIONS
  turinabol_anavar: {
    description: "Performance-focused dual oral with managed hepatic load.",
    synergy: { benefit: 0.15, risk: 0.2 },
    mechanisms: [
      "Two mild orals stack well for athletes seeking lean gains without heavy bloat.",
      "Anavar adds neural drive and hardness to Tbol's steady gains.",
      "Dual oral hepatic load requires liver support and monitoring.",
    ],
    recommendedRatio: "Tbol 40-60mg + Anavar 40-50mg",
    recommendedProtocol: {
      tudca: "500-1000mg daily",
      duration: "6-8 weeks",
    },
    recommendation: "Good for athletic performance or lean bulk",
    caution: "Hepatic stress accumulates; monitor lipids",
    stackBenefit: "Lean mass, strength, no water",
    stackRisk: "Moderate: hepatic, lipids",
    rating: "good",
  },

  npp_proviron: {
    description: "Functional synergy; Proviron mitigates 'Deca Dick'.",
    synergy: { benefit: 0.2, risk: 0.05 },
    mechanisms: [
      "Proviron provides DHT androgenicity that NPP lacks, maintaining libido and mood.",
      "NPP provides mass/joints; Proviron provides drive/hardness.",
    ],
    recommendedRatio: "NPP 300-400mg + Proviron 50mg",
    recommendation: "Highly recommended to prevent sexual dysfunction from 19-nors",
    caution: "Hair loss (Proviron)",
    stackBenefit: "Mass with libido protection",
    stackRisk: "Low-Moderate",
    rating: "excellent",
  },

  trenbolone_proviron: {
    description: "Elite cosmetic stack with libido preservation.",
    synergy: { benefit: 0.25, risk: 0.1 },
    mechanisms: [
      "Proviron enhances Tren's cosmetic effects while providing DHT support for libido.",
      "Extremely dry and hard look.",
    ],
    recommendedRatio: "Tren 300mg + Proviron 50mg",
    recommendation: "Excellent for contest prep",
    caution: "Hair loss; Tren sides",
    stackBenefit: "Peak aesthetics + libido support",
    stackRisk: "Moderate (Tren dependent)",
    rating: "excellent",
  },

  superdrol_turinabol: {
    description: "Dual oral with extreme hepatic burden.",
    synergy: { benefit: 0.1, risk: 0.8 },
    mechanisms: [
      "Minimal synergy - dual methylated stress outweighs marginal benefit.",
      "High hepatic burden.",
    ],
    recommendation: "Not recommended",
    caution: "Liver toxicity",
    stackBenefit: "Strength",
    stackRisk: "High",
    rating: "caution",
  },
...
export const calculateStackSynergy = (compounds, options = {}) => {
  ...
  const { compounds: compoundKeys, doses } = normalizeStackInput(
    compounds,
    suppliedDoses,
  );
...
export const getCompoundInteractions = (compoundKey, options = {}) => {
  ...
  Object.entries(interactionMatrix).forEach(([key, data]) => {
    if (key.includes(compoundKey)) {
      const otherCompound = key
        .replace(`${compoundKey}_`, "")
        .replace(`_${compoundKey}`, "");
